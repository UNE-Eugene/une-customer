...
import json
import HotelMessage.models as hmm
...
def city_date(form):
    hotel_list = hmm.THotelInfo.objects.filter(city=form['city']).all()
    print(hotel_list)
    return None
