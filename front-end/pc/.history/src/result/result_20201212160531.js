    ...
    <Layout>
      ...
      <div className="content-result">
        <Input.Group compact={true} className='InputGroup'>
            ...
            <AutoComplete style={{position: "absolute", width: '15%', left: '15%'}}/>
            <AutoComplete style={{position: "absolute", width: '15%', left: '30%'}}/>
            <AutoComplete style={{position: "absolute", width: '15%', left: '45%'}}/>
            <AutoComplete style={{position: "absolute", width: '15%', left: '60%'}}/>
        </Input.Group>
