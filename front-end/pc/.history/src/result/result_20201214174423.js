    ...
    <Row style={{ height: "200px", width: "100%" }}>
      <Col span={6} style={{display: 'flex'}}>
        <img
          src={hotelJPG}
          alt=""
          style={{ height: "200px", width: "65%", alignSelf: 'center',alignItems: 'center', margin: '20px auto' }}
        />
      </Col>
      <Col span={18}>
        <Row gutter={[16, 10]}>
          <Col span={24} style={{display: 'flex'}}>
            <Text style={{fontSize: '20px', fontWeight: '700', alignSelf: 'center', display: 'flex'}}>广州东圃合景福朋喜来登酒店{<Tag color='gold' style={{alignSelf: 'center'}}>SSS</Tag>}</Text>
          </Col>
          <Col span={24} style={{display: 'flex'}}>
          ...
          <Col span={12} style={{display: 'flex'}}>
            <Tag style={{alignSelf: 'center', height: '25px', fontSize: '13px'}}>地铁周边</Tag>
          </Col>
          <Col span={12} style={{display: 'flex'}}>
            <Tag style={{alignSelf: 'center', height: '25px', fontSize: '13px'}}>亲子套房</Tag>
          </Col>
          <Col span={24} style={{display: 'flex'}}>
            <Text style={{alignSelf: 'center', height: '30px'}}>{<EnvironmentFilled />} 广州市东圃汇彩路菁映路1号</Text>
          </Col>
        </Row>
      </Col>
    </Row>
