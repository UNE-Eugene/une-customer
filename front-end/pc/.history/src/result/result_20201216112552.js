...
const columns = [
  ...
  },
  {
    ...
    dataIndex: "tags",
    render: (tags) => (
      <Badge dot={true} style={{alignSelf: 'center', height: '20px', width: '20px', backgroundColor: 'red'}}/>
    ),
  },
  ...
  return (
    <Layout style={{ position: "relative", height: "100%", width: "100%" }}>
      ...
      <section className="result-content">
        ...
        <Space
          style={{ position: "absolute", top: "10%", left: "20%", minWidth: '800px', width:"60%" }}
          direction="vertical"
        >
          <Card className="result-card" hoverable title={<TitleRender />}>
            ...
            <div>&nbsp;</div>
            <Table columns={columns} style={{display: 'flex'}} dataSource={data} pagination={false} />
          </Card>
          <Card className="result-card" hoverable title={<TitleRender />}>
            <div style={{ display: "flex" }}>
              <Text
            ...
            <div>&nbsp;</div>
            <Table columns={columns} dataSource={data} pagination={false} rowClassName='result-table' />
          </Card>
          <Card className="result-card" hoverable title={<TitleRender />}>
            <div style={{ display: "flex" }}>
              <Text
