      ...
      <div className="content-result">
        <Input.Group compact={true} className="InputGroup">
          <AutoComplete
            ...
            children={<Input style={{ height: "40px" }} placeholder="城市" />}
          />
          <AutoComplete
            style={{ width: "20%", height: "100%" }}
            children={<Input style={{ height: "40px" }} placeholder="酒店" />}
          />
          <AutoComplete
            style={{ width: "15%", height: "100%" }}
            children={<Input style={{ height: "40px" }} placeholder="商圈" />}
          />
          <AutoComplete
            style={{ width: "10%", height: "100%" }}
            children={<Input style={{ height: "40px" }} placeholder="集团" />}
          />
          <InputNumber style={{ alignSelf: "center", height: "40px" }} placeholder='预算'/>
              <RangePicker
                key="1"
              ...
              />
          <Button style={{height: '40px', width: '7%'}}>123</Button>
        </Input.Group>
      </div>
    </Layout>
  );
