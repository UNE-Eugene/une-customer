  ...
  return (
    <Row style={{ height: "200px", width: "100%" }}>
      ...
      <Col span={18}>
        <Row gutter={[16, 20]}>
          <Col span={24}>
            <Text style={{fontSize: '20px', fontWeight: '700'}}>广州东圃合景福朋喜来登酒店</Text>
          </Col>
          <Col span={24}>
            <Paragraph 
            ellipsis={{
              rows: 1,
              expandable: true,
              onEllipsis: ellipsis => {console.log(ellipsis)}
              }}>
              备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注备注
            </Paragraph>
          </Col>
          <Col span={12}>
            <Tag>地铁周边</Tag>
