      ...
      <div className="result-content">
        <Input.Group compact={true} className="InputGroup">
          <AutoComplete
            ...
            children={<Input style={{ height: "50px" }} placeholder="城市" />}
          />
          <AutoComplete
            style={{ width: "20%", height: "100%" }}
            children={<Input style={{ height: "50px" }} placeholder="酒店" />}
          />
          <AutoComplete
            style={{ width: "15%", height: "100%" }}
            children={<Input style={{ height: "50px" }} placeholder="商圈" />}
          />
          <AutoComplete
            style={{ width: "10%", height: "100%" }}
            children={<Input style={{ height: "50px" }} placeholder="集团" />}
          />
          <RangePicker
            key="1"
            style={{ alignSelf: "center", height: "50px", width: "20%", textAlign: 'center' }}
          ...
          />
          <Button style={{ height: "50px", width: "7%" }}>123</Button>
        </Input.Group>
      </div>
    </Layout>
  );
