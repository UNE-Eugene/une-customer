    ...
    <Layout>
      ...
      <div className="content-result">
        <Input.Group compact={true} className="InputGroup">
          <AutoComplete style={{ width: "15%", height: "100%" }} placeholder='城市' children={<Input style={{height:"40px"}}/>}/>
          <AutoComplete style={{ width: "15%", height: "100%" }} placeholder='酒店' />
          <AutoComplete style={{ width: "15%", height: "100%" }} placeholder='商圈' />
          <AutoComplete style={{ width: "15%", height: "100%" }} placeholder='集团' />
          <AutoComplete style={{ width: "15%", height: "100%" }} placeholder='日期' />
          <Button>123</Button>
        </Input.Group>
      </div>
    </Layout>
