    ...
    <Row style={{ height: "200px", width: "100%" }}>
      <Col span={6} style={{display: 'flex'}}>
        <img
          src={hotelJPG}
          alt=""
          style={{ height: "200px", width: "65%", alignSelf: 'center',alignItems: 'center', margin: 'auto' }}
        />
      </Col>
      <Col span={18}>
        <Row gutter={[16, 10]}>
          <Col span={24} style={{display: 'flex'}}>
            <Text style={{fontSize: '20px', fontWeight: '700', alignSelf: 'center', display: 'flex'}}>广州东圃合景福朋喜来登酒店&bsp;{<Tag color='gold' style={{alignSelf: 'center'}}>SSS</Tag>}</Text>
          </Col>
          <Col span={24} style={{display: 'flex'}}>
