    ...
    <Layout>
      ...
      <div className="content-result">
        <Input.Group compact={true} className='InputGroup'>
            <AutoComplete style={{position: "absolute", width: '15%', height: '100%'}}/>
            <AutoComplete style={{position: "absolute", width: '15%', left: '15%', height: '100%'}} height={'100%'}/>
            <AutoComplete style={{position: "absolute", width: '15%', left: '30%', height: '100%'}}/>
            <AutoComplete style={{position: "absolute", width: '15%', left: '45%', height: '100%'}}/>
            <AutoComplete style={{position: "absolute", width: '15%', left: '60%', height: '100%'}}/>
        </Input.Group>
