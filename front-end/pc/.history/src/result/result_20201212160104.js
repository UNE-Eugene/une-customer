    ...
    <Layout>
      ...
      <div className="content-result">
        <Input.Group compact={true} className='InputGroup'>
            <AutoComplete style={{position: "absolute", width: '20%'}}/>
            <AutoComplete style={{position: "absolute", width: '20%', left: '20%'}}/>
            <AutoComplete style={{position: "absolute", width: '20%', left: '40%'}}/>
            <AutoComplete style={{position: "absolute", width: '20%', left: '60%'}}/>
            <AutoComplete style={{position: "absolute", width: '20%', left: '80%'}}/>
        </Input.Group>
