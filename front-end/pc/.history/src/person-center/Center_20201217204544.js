...
const Center = (props) => {
  ...
  const [TabContent, setTabContent] = useState(contentList[TabKey])
  ...
  useEffect(() => {
    setTabContent(contentList[TabKey])
  }, [TabKey])
  return (
            ...
            <>
              <QueueAnim type="left" delay={0}>
                <Card
                  ...
                  tabList={tabList}
                  activeTabKey={TabKey}
                  onTabChange = {key=>{console.log(TabKey);setTabKey(key);console.log(key);}}
                >
                  {TabContent}
                </Card>
              </QueueAnim>
