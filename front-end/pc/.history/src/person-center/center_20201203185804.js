...
import icon1_1 from "./static/icon3-3.png";
import icon2_2 from "./static/icon3-3.png";
        ...
        <Sider className="side" width="4vw">
          <Menu mode="inline" className="menu" theme="dark" onClick={()=>{}}>
            <Menu.Item
              ...
              onClick={()=>{document.getElementById('icon1').src=icon1_1;
            ...
            <Menu.Item
              ...
              onClick={()=>{document.getElementById('icon2').src=icon2_2;
