...
const menu = (
  <Menu className='dropdown'>
    <Menu.Item onClick={{}} style={{width: '100px',height: '60px', borderRadius:'10px', display: 'table-cell',verticalAlign:'middle'}}>
      上传头像
    </Menu.Item>
    <Menu.Item style={{width: '100px',height: '60px', borderRadius:'10px', display: 'table-cell',verticalAlign:'middle'}}>
      修改密码
    </Menu.Item>
  </Menu>
);
