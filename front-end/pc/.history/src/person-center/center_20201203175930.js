        ...
        <Sider className="side" width="4vw">
          <Menu mode="inline" className="menu" theme="dark">
            ...
            >
                ...
                <Text style={{position: "absolute",  height: "1vw", width: "2vw", top: '3vw', left: '1vw', minWidth: "2vw", fontFamily: 'Georgia, serif', fontWeight: '800', fontSize: '1vw', textAlign: 'center', color: 'gray'}}>查 询</Text>
                <Text style={{position: "absolute",  height: "1vw", width: "2vw", top: '4vw', left: '1vw', minWidth: "2vw", fontFamily: 'Georgia, serif', fontWeight: '800', fontSize: '1vw', textAlign: 'center', color: 'gray'}}>系 统</Text>
            </Menu.Item>
            <Menu.Item
              key="2"
