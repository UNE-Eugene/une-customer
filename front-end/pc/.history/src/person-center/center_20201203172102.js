      ...
      <Layout className="body">
        <Sider className="side" width="4vw">
          <Menu mode="inline" className="menu" theme="dark">
            ...
            >
                <img style={{position: "absolute",  height: "2vw", width: "2vw"}} src={icon1} alt="" />
            </Menu.Item>
            <Menu.Item
              key="2"
              style={{ position: 'absolute', height: "4vw", width: "4vw", paddingLeft: 0, top: '7vw', textAlign: "center" }}
            >
                <img style={{position: "absolute",  height: "2vw", width: "2vw"}} src={icon2} alt="" />
            </Menu.Item>
            <Menu.Item
              key="3"
              style={{ position: 'absolute', height: "4vw", width: "4vw", paddingLeft: 0, top: '13vw' }}
            >
                <img style={{position: "absolute",  height: "2vw", width: "2vw"}} src={icon3} alt="" />
            </Menu.Item>
          </Menu>
        </Sider>
