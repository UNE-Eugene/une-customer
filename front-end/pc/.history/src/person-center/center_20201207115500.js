    ...
    <Layout className="main">
      ...
      <Layout className="body">
        ...
        <Content className="content">
          <Tabs defaultActiveKey="1" className="table-mission" style={{zIndex: '3'}}>
            <TabPane tab="转出任务" key="1">
              <Table columns={columns} dataSource={data} pagination={{ position: ['topRight'] }} style={{position: 'absolute',zIndex: '2', width: '100%'}}/>
            </TabPane>
