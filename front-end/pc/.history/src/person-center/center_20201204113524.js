    ...
    <Layout className="main">
      <Header className="header">
        ...
        <Row className='avatar'gutter={16} >
          <Col xs={11} sm={11} md={9} lg={6} xl={5} xxl={4}>
            <Avatar size={{ xs: 30, sm: 30, md: 30, lg: 30, xl: 40, xxl: 50 }} />
          </Col>
          <Col xs={13} sm={13} md={15} lg={18} xl={19} xxl={20} offset={1}>
            <Text className='workerNumber'>工号：</Text>
          </Col>
        </Row>
      </Header>
