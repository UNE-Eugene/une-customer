        ...
        <Sider className="side" width="4vw">
          <Menu mode="inline" className="menu" theme="dark" onClick={()=>{}}>
            ...
            >
                ...
                <Text id='icon1' style={{position: "absolute",  height: "1vw", width: "2vw", top: '3vw', left: '1vw', minWidth: "2vw", fontFamily: 'Georgia, serif', fontWeight: '800', fontSize: '0.75vw', textAlign: 'center', color: 'gray'}}>日 志</Text>
                <Text id='icon1' style={{position: "absolute",  height: "1vw", width: "2vw", top: '4vw', left: '1vw', minWidth: "2vw", fontFamily: 'Georgia, serif', fontWeight: '800', fontSize: '0.75vw', textAlign: 'center', color: 'gray'}}>查 询</Text>
            </Menu.Item>
          </Menu>
        </Sider>
