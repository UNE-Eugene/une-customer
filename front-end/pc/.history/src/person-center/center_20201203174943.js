        ...
        <Sider className="side" width="4vw">
          <Menu mode="inline" className="menu" theme="dark">
            ...
            >
                ...
                <Text style={{position: "absolute",  height: "2vw", width: "2vw", top: '3vw', left: '1vw', minWidth: "2vw"}}>查询</Text>
                <Text style={{position: "absolute",  height: "2vw", width: "2vw", top: '3vw', left: '1vw', minWidth: "2vw"}}>系统</Text>
            </Menu.Item>
            <Menu.Item
              key="2"
