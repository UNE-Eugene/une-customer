...
const menu = (
  <Menu className='dropdown'>
    <Menu.Item onClick={{}} style={{position: "absolute",width: '100px',height: '60px', borderRadius:'10px'}}>
      <Text style={{position: "absolute", top: '10px', height: '40px'}}>上传头像</Text>
    </Menu.Item>
    <Menu.Item style={{width: '100px', height: '60px', borderRadius:'10px'}}>
      修改密码
    </Menu.Item>
  </Menu>
);
