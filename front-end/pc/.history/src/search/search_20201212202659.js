        ...
        <div className="form">
          ...
          >
            <Row className="row" key="group-row">
              ...
              <Col span={20} >
                <Slider range defaultValue={[0, 10000]} step={50} min={0} max={10000} onChange={()=>{}}/>
              </Col>
            </Row>
            <InputNumber style={{height: '45%', width:'8%', alignSelf: 'center'}} key="budget1" />
                <ArrowRightOutlined  style={{alignSelf: 'center', margin: '20px auto', width: '4%'}}/>
                <InputNumber  key="budget2" style={{height: '45%', width:'8%', alignSelf: 'center'}}/>
          </div>
          <div
            className="inputArea"
            style={{ top: "80%", left: 0 }}
