              ...
              <Col span={20} style={{ display: "flex" }} key="date-col">
                <RangePicker
                  ...
                  onCalendarChange={(dates, dateString, info) => {
                    switch (dateString[1]) {
                      case dateString[0]: setDateChecked(`${dateString[0]}入住${moment(dates[1].add(1, "days"), dateFormat)}离开`);
                                          break;
                      case "":setDateChecked(`${dateString[0]}入住${moment(dates[1].add(1, "days"), dateFormat)}离开`);
                                break;
                      default:
