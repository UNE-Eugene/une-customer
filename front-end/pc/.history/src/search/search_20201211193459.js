...
const Search = (props) => {
  ...
  const tagRender = (props) => {
    ...
    const onClose = (e)=>{
      switch (label) {
        case cityChecked: setCityChecked('');
                          break;
        case hotelChecked: setHotelChecked('');break;
        case tradeChecked: setTradeChecked('');break;
        case groupChecked: setGroupChecked('');break;
        case dateChecked: setDateChecked('');break;
        default:
          break            
      }
    }
