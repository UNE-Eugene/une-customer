      ...
      <Card className="card">
        ...
        <div className='form'>
          <div className='InputArea'>
            <label style={{top: '10%', left: 0}} className='form-label'>城市：</label>
            <Row className='row' style={{top: '10%', left: '10%'}}>
              <Col span={6}>
          ...
          <div className='InputArea'>
            <Row className='row' style={{top: '26%', left: '10%'}}>
              <Col>
              </Col>
            </Row>
          </div>
          <div className='InputArea'>
            <Row className='row' style={{top: '42%', left: '10%'}}>
              <Col>
              </Col>
            </Row>
          </div>
          <div className='InputArea'>
            <Row className='row' style={{top: '58%', left: '10%'}}>
              <Col>
              </Col>
            </Row>
          </div>
          <div className='InputArea'>
            <Row className='row' style={{top: '74%', left: '10%'}}>
              <Col>
              </Col>
            </Row>
          </div>
