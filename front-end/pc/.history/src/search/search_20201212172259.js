...
import "./search.css";
import { Row, Col, Button, Input, Card, Select, DatePicker, Tag, InputNumber } from "antd";
        ...
        <div className="form">
          ...
          >
            <Row className="row" key="group-row">
              ...
              <Col span={8}>
                <InputNumber className="form-input" key="budget1"/>
              </Col>
              <Col span={4}>&nbsp;</Col>
              <Col span={8}>
              <InputNumber className="form-input" key="budget2"/>
              </Col>
            </Row>
          </div>
          <div
          ...
          >
            ...
            <Button className="form-submit" key="date" onClick={()=>{props.history.push('/result')}}>
              搜索
            </Button>
          </div>
        </div>
