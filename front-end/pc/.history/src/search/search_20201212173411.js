          ...
          >
            <Row className="row" key="group-row">
              ...
              <Col span={8} style={{ display: "flex" }}>
                <InputNumber style={{height: '50%', width:'100%', alignSelf: 'center'}} key="budget1" />
              </Col>
              <Col span={4} style={{ display: "flex" }}>&nbsp;</Col>
              <Col span={8} style={{ display: "flex" }}>
                <InputNumber  key="budget2" style={{height: '50%', width:'100%', alignSelf: 'center'}}/>
              </Col>
            </Row>
          </div>
          <div
