        ...
        <div className="form">
          ...
          >
            <Row className="row" key="group-row">
              ...
              <Col span={20} >
                <Slider range defaultValue={[0, 10000]} step={50} min={0} max={10000} />
              </Col>
              <Col span={8} style={{ display: "flex" }}>
                <InputNumber style={{height: '45%', width:'100%', alignSelf: 'center'}} key="budget1" />
              </Col>
              <Col span={4} style={{ display: "flex", textAlign: 'center' }}>
                <ArrowRightOutlined  style={{alignSelf: 'center', margin: '20px auto'}}/>
              </Col>
              <Col span={8} style={{ display: "flex" }}>
                <InputNumber  key="budget2" style={{height: '45%', width:'100%', alignSelf: 'center'}}/>
              </Col>
            </Row>
          </div>
          <div
