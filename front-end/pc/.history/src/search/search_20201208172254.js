...
const Search = () => {
  ...
  return (
    <div className="background">
      ...
      <Button className="simple" style={buttonChecked === 1?checked:unChecked} onClick={()=>{setbuttonChecked(1)}}>
        基础
      </Button>
      <Button className="advance" style={buttonChecked === 2?checked:unChecked} onClick={()=>{setbuttonChecked(2)}}>
        高级
      </Button>
    </div>
  );
