  ...
  return (
    ...
    >
      ...
      <Card className="card">
        ...
        <div className="form">
          <div className="InputArea" style={{ position: 'absolute',top: "10%", left: 0 }}>
            <Row className="row" style={{ top: "10%", left: 0 }}>
              <Col span={4} style={{ display: "flex" }}>
                <label style={{ top: "10%", left: 0, alignSelf: "center" }}>
                  城市：
                </label>
              </Col>
              {city.map((item, index) => {
          ...
          <div className="InputArea" style={{ position: 'absolute',top: "26%", left: 0 }}>
            <Row className="row" style={{ top: "26%", left: 0 }}>
              <Col span={4} style={{ display: "flex" }}>
                <label style={{ top: "26%", left: 0, alignSelf: "center" }}>
                  城市：
                </label>
              </Col>
            </Row>
          ...
          <div className="InputArea" >
            <Row className="row" style={{ top: "42%", left: 0 }}>
              <Col span={4} style={{ display: "flex" }}>
                <label style={{ top: "42%", left: 0, alignSelf: "center" }}>
                  城市：
                </label>
              </Col>
            </Row>
          ...
          <div className="InputArea">
            <Row className="row" style={{ top: "58%", left: 0 }}>
              <Col span={4} style={{ display: "flex" }}>
                <label style={{ top: "58%", left: 0, alignSelf: "center" }}>
                  城市：
                </label>
              </Col>
            </Row>
          ...
          <div className="InputArea">
            <Row className="row" style={{ top: "74%", left: 0 }}>
              <Col span={4} style={{ display: "flex" }}>
                <label style={{ top: "74%", left: 0, alignSelf: "center" }}>
                  城市：
                </label>
              </Col>
            </Row>
